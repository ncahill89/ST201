...
## What is Simpson's Paradox? {style="font-size: 70%;"}
...
## Overall Success Rates (ignoring hospital) {style="font-size: 70%;"}
...
## Success Rates for Treatment by Hospital {style="font-size: 70%;"}
...
In this example, Simpson's paradox occurred because
...
## 2-way mosaic plots {style="font-size: 70%;"}
...
## 3-way mosaic plots {style="font-size: 60%;"}
...
```{r, echo=TRUE}
xtabs(Freq ~ + Sex + Survived + Class, data = Titanic)
```
