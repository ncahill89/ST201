...
-   e.g., we may want to find out if female employees at a company are paid less than male employees or vice versa. Assume in this example we have two salary categories (low, high).
...
## Hypothesis Testing: The Big Picture {style="font-size: 60%;"}

**Purpose:** To determine if an observed effect or relationship is statistically significant or just due to random chance.

**Key Steps:**

  - State hypotheses
    
    - Null hypothesis ($H_o$): No effect or no relationship.
    - Alternative hypothesis ($H_a$): There is an effect or relationship.

  - Choose a significance level (α)

    - Common choice: 0.05 (5% risk of rejecting H₀ when it’s true)

  - Select a test statistic

    - Depends on data type and goal (e.g., t-test, chi-squared)

  - Calculate p-value

    - Probability of observing data as extreme as ours if H₀ is true.
...
-   the *null* hypothesis is **independence** (no relationship)
-   the *alternative* hypothesis is **no independence** (relationship)
